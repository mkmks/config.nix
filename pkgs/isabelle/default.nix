...
stdenv.mkDerivation {
  ...
  src = if stdenv.isDarwin
    then fetchurl {
      ...
      sha256 = "57673898464a443b9c40b2476973950d557c9905a3c739844e37ecc033a748a4";
    };
  ...
  postPatch = ''
    ...
    sed -i 's|-Djava.ext.dirs=$(platform_path "$ISABELLE_JDK_HOME/jre/lib/ext")||g' lib/Tools/java
